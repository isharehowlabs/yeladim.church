...
export default function VideoStream() {
  ...
  return (
    <div className="w-full">
      <form onSubmit={handleSubmit} className="mb-4 bg-gradient-to-r from-purple-50 to-pink-50 p-3 sm:p-4 md:p-6 rounded-lg shadow-lg border-2 border-purple-200">
        <div className="flex gap-3 sm:gap-4 md:gap-6 flex-col md:flex-row md:items-end">
          ...
          <div className="flex-[2] min-w-0 md:min-w-[300px]">
            <label className="block text-sm md:text-base font-medium text-gray-700 mb-2">
          ...
          <button
            type="submit"
            className="w-full md:w-auto px-6 py-2 md:py-3 text-sm md:text-base bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-md hover:from-purple-700 hover:to-pink-700 transition-all shadow-md hover:shadow-lg font-semibold"
          >
            Load Stream
          </button>
        </div>
